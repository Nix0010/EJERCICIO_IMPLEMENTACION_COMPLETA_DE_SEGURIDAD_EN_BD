...
El objetivo principal de este proyecto es demostrar la aplicación práctica de los principios de seguridad de bases de datos, cubriendo los siguientes pilares:

Control de Acceso: Implementación de roles y el Principio de Mínimo Privilegio.

Confidencialidad: Uso de Vistas de Seguridad para proteger datos sensibles (PII).
